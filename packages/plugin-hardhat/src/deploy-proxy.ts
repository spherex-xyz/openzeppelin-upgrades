  ...
  return async function deployProxy(
    ...
    switch (kind) {
      ...
      case 'uups': {
        ...
        const ProtectedProxyFactory = await getProtectedProxyFactory(hre, ImplFactory.signer);
        proxyDeployment = Object.assign({ kind }, await deploy(ProtectedProxyFactory, impl, data));
        break;
      }
